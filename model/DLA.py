...
class DLAImplementation(nn.Module):
    def __init__(self, block=BasicBlock, num_classes=10):
        super(DLAImplementation, self).__init__()
...
class DLA(DLAImplementation, ModelBase):
    def __init__(self, num_classes, *args, **kwargs):
        super().__init__()

        self.dla = DLAImplementation(num_classes=num_classes)
