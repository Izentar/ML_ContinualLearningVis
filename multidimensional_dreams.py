...
if __name__ == "__main__":
    ...
    select_dream_tasks_f = datMan.classic_select_tasks    
    ...
    cl_data_module = CLDataModule(
        ...
        tasks_processing_f=lambda tasks : datMan.normall_dist_tasks_processing(tasks, get_mean_var_f=loss_object_f.get_mean_var)
    )
